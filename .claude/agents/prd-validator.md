---
name: prd-validator
description: "PRD(제품 요구사항 문서)를 기술적 관점에서 검증합니다. Chain-of-Thought 방식으로 기술 타당성, 구현 복잡도, 잠재적 리스크를 단계별로 분석합니다. 개발 시작 전 PRD 검토가 필요할 때 사용하세요. 예: 'PRD 기술 검증해줘', '이 요구사항의 기술적 리스크 분석해줘', 'PRD 타당성 검토해줘'"
model: opus
---
